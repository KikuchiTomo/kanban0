class kanban0 {
    constructor(config) {
        ...
        for(let i=0; i<kanbans_len; i++){
            ...
            header_div.innerHTML = this.kanbans_[i].dataset.title;
            main_div.id          = `${this.kanbans_[i].id}-main`
            header_div.id        = `${this.kanbans_[i].id}-title`
            main_div.className   = 'kanban-droparea'
            header_div.className = 'kanban-title'
            this.kanbans_[i].appendChild(header_div);
            this.kanbans_[i].appendChild(main_div);
        }
